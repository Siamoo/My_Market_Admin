...
import 'package:my_market_admin/features/products/views/comments_view.dart';
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(product.description?? 'description', style: TextStyle(fontSize: 22)),
                    SizedBox(height: 10),
                ...
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(product.oldPrice ?? 'oldPrice', style: TextStyle(fontSize: 22)),
                    SizedBox(height: 10),
                    CustomElevatedButton(
                      width: width * .05,
                      height: height * .05,
                      ...
                      onPressed: () {
                        NavigationService.pushTo(context, CommentsView());
                      },
                    ),
                  ],
                ),
