...
class _AddProductViewState extends State<AddProductView> {
      ...
      child: BlocConsumer<ProductsCubit, ProductsState>(
        listener: (context, state) {
          if (state is AddProductSuccess) {
            NavigationService.pushTo(context, const ProductsView());
          }
        },
        builder: (context, state) {
          ProductsCubit cubit = context.read<ProductsCubit>();
          return Scaffold(
            appBar: customAppBar(context, 'Add Products'),
                    ...
                    await pickImage().then((value) {
                      setState(() {
                        if (value != null) {
                          ...
                          Uint8List? image = value.files.first.bytes;
  ...
  DropdownMenu<String> _buildCustomDropMenu() {
    return DropdownMenu(
      ...
      dropdownMenuEntries: [
        DropdownMenuEntry(label: 'collections', value: 'collections'),
        DropdownMenuEntry(label: 'electronics', value: 'electronics'),
